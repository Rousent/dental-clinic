    ...
    <>
      <div className=" flex items-center justify-center">
        <div className="bg-white shadow-md rounded-md p-6 w-96 mt-7 mb-7">
          {/* Título centrado */}
          <h2 className="text-center text-xl font-semibold mb-4">Crear cita</h2>
          ...
          >
            ...
            <div className="mb-4">
              ...
              <select
                ...
                required
              >
                <option defaultValue="">Seleccione un paciente</option>
            ...
            <div className="mb-4">
              ...
              <select
                ...
                required
              >
                <option defaultValue="">Seleccione al especialista</option>
