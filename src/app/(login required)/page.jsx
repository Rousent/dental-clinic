...
export default function Home() {
  ...
  const [selectedEspecialistaData, setSelectedEspecialistaData] = useState(null);
          ...
          try {
            ...
            const events = await Promise.all(
              data.map(async (cita) => {
                ...
                const especialistaData = await ObtenerDatosEspecialista(cita.especialista);
      ...
      <Modal isOpen={isModalOpen}  onClose={handleCloseModal} className="text-lg">
        <ModalContent>
          ...
          {selectedEspecialistaData && (
              <>
                <p><b>Especialista: </b>{selectedEspecialistaData.nombre}{" "}{selectedEspecialistaData.apellido_paterno}{" "}{selectedEspecialistaData.apellido_materno}</p>
                {/* Agrega más detalles del paciente según tus necesidades */}
              </>
            )}
            {selectedPatientData && (
              <>
                <p><b>Paciente: </b>{selectedPatientData.nombre}{" "}{selectedPatientData.apellido_paterno}{" "}{selectedPatientData.apellido_materno}</p>
